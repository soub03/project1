    ...
    return (
        <div style={{
            ...
            <style>
                ...
                @keyframes pulseGlow {
                    0% { text-shadow: 0 0 10px rgba(59,130,246,0.5), 0 0 20px rgba(59,130,246,0.3); }
                    50% { text-shadow: 0 0 20px rgba(59,130,246,0.8), 0 0 40px rgba(59,130,246,0.5); }
                    100% { text-shadow: 0 0 10px rgba(59,130,246,0.5), 0 0 20px rgba(59,130,246,0.3); }
                }
                .start-btn:hover {
            ...
            <div style={{ zIndex: 10, textAlign: 'center', maxWidth: '800px', padding: '2rem' }}>
                <div style={{
                ...
                <p style={{
                    ...
                    Next-generation predictive analytics engine. Monitor global energy mix, assess regional poverty impact, and forecast peak grid demand using advanced computational models.
                </p>
